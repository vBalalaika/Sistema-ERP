...
namespace ERP.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "el password y confirmación de password no coinciden.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Body = $"Por favor, confirma tu cuenta en <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>click aquí</a>.",
